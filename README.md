...
**configurar las alertas por email desde la UI** (Gmail/Outlook/cualquier SMTP, con
botón de prueba; critical inmediato, warning agrupado), **monitoreo completo**
(Prometheus + Grafana + exporters) e **historial de alertas** en el Portal.
